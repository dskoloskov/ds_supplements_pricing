...
Мой пет-проект, в котором я прошел весь путь от сбора "грязных" данных из недокументированного API до готовой реляционной базы до проведения глубокого исследовательского анализа (EDA) и построения детальных визуализаций. Тему выбрал не случайно: я сам занимаюсь в зале и разбираюсь в добавках, поэтому мне было интересно посмотреть на рынок со стороны данных.
